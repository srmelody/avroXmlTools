...
/**
 * <p>Java class for LeaveEventDescriptorType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="LeaveEventDescriptorType">
 ...
 * 
 */
@XmlType(name = "LeaveEventDescriptorType")
@XmlEnum
public enum LeaveEventDescriptorType {
    ...
    LeaveEventDescriptorType(String v) {
        value = v;
    }
    ...
    public static LeaveEventDescriptorType fromValue(String v) {
        for (LeaveEventDescriptorType c: LeaveEventDescriptorType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
