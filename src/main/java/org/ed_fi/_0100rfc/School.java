 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://ed-fi.org/0100RFC}EducationOrganization">
 *       &lt;sequence>
 *         &lt;element name="GradesOffered" type="{http://ed-fi.org/0100RFC}GradeLevelsType"/>
 *         &lt;element name="SchoolCategories" type="{http://ed-fi.org/0100RFC}SchoolCategoriesType"/>
 *         &lt;element name="SchoolType" type="{http://ed-fi.org/0100RFC}SchoolType" minOccurs="0"/>
 *         &lt;element name="CharterStatus" type="{http://ed-fi.org/0100RFC}CharterStatusType" minOccurs="0"/>
 *         &lt;element name="TitleIPartASchoolDesignation" type="{http://ed-fi.org/0100RFC}TitleIPartASchoolDesignationType" minOccurs="0"/>
 *         &lt;element name="MagnetSpecialProgramEmphasisSchool" type="{http://ed-fi.org/0100RFC}MagnetSpecialProgramEmphasisSchoolType" minOccurs="0"/>
 *         &lt;element name="AdministrativeFundingControl" type="{http://ed-fi.org/0100RFC}AdministrativeFundingControlType" minOccurs="0"/>
 *         &lt;element name="LocalEducationAgencyReference" type="{http://ed-fi.org/0100RFC}EducationalOrgReferenceType"/>
 *         &lt;element name="ClassPeriodReference" type="{http://ed-fi.org/0100RFC}ReferenceType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="LocationReference" type="{http://ed-fi.org/0100RFC}ReferenceType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends EducationOrganization
{
    ...
    @XmlElement(name = "LocalEducationAgencyReference", required = true)
