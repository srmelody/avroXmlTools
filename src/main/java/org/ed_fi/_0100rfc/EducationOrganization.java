 ...
 *         &lt;element name="EducationOrgIdentificationCode" type="{http://ed-fi.org/0100RFC}EducationOrgIdentificationCode" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="NameOfInstitution" type="{http://ed-fi.org/0100RFC}NameOfInstitution"/>
 *         &lt;element name="ShortNameOfInstitution" type="{http://ed-fi.org/0100RFC}NameOfInstitution" minOccurs="0"/>
 *         &lt;element name="OrganizationCategories" type="{http://ed-fi.org/0100RFC}EducationOrganizationCategoriesType"/>
 *         &lt;element name="Address" type="{http://ed-fi.org/0100RFC}Address" maxOccurs="unbounded"/>
 *         &lt;element name="Telephone" type="{http://ed-fi.org/0100RFC}InstitutionTelephone" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="WebSite" type="{http://ed-fi.org/0100RFC}WebSite" minOccurs="0"/>
 *         &lt;element name="OperationalStatus" type="{http://ed-fi.org/0100RFC}OperationalStatusType" minOccurs="0"/>
 *         &lt;element name="AccountabilityRatings" type="{http://ed-fi.org/0100RFC}AccountabilityRating" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ProgramReference" type="{http://ed-fi.org/0100RFC}ProgramReferenceType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="EducationOrganizationPeerReference" type="{http://ed-fi.org/0100RFC}EducationalOrgReferenceType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
