...
/**
 * Encapsulates the possible attributes that can be used to lookup the identity of educational orgnizations, specially ESCs, LEAs (districts), and schooles.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="StateOrganizationId" type="{http://ed-fi.org/0100RFC}IdentificationCode" minOccurs="0"/>
