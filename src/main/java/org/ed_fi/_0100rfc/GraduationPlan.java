...
/**
 * A plan outlining the required credits, credits by subject, credits by course, and other criteria required for graduation.  A graduation plan may be one or more standard plans defined by an education organization and/or individual plans for some or all students.
 * 
 ...
 *           &lt;simpleType>
 *             &lt;restriction base="{http://ed-fi.org/0100RFC}GraduationPlanType">
 *             &lt;/restriction>
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="IndividualPlan" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="TotalCreditsRequired" type="{http://ed-fi.org/0100RFC}Credits"/>
 *         &lt;element name="CreditsBySubject" type="{http://ed-fi.org/0100RFC}CreditsBySubject" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="CreditsByCourse" type="{http://ed-fi.org/0100RFC}CreditsByCourse" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
