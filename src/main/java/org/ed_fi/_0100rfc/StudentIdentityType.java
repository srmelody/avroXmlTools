 ...
 *       &lt;sequence>
 *         &lt;element name="StudentUniqueStateId" type="{http://ed-fi.org/0100RFC}UniqueStateIdentifier" minOccurs="0"/>
...
public class StudentIdentityType {
    ...
    protected Integer studentUniqueStateId;
    ...
    @XmlElementRef(name = "HispanicLatinoEthnicity", namespace = "http://ed-fi.org/0100RFC", type = JAXBElement.class)
     ...
     *     
     */
    public Integer getStudentUniqueStateId() {
     ...
     *     
     */
    public void setStudentUniqueStateId(Integer value) {
