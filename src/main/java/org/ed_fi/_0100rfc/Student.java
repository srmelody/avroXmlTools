 ...
 *       &lt;sequence>
 *         &lt;element name="StudentUniqueStateId" type="{http://ed-fi.org/0100RFC}UniqueStateIdentifier"/>
 *         &lt;element name="StudentIdentificationCode" type="{http://ed-fi.org/0100RFC}StudentIdentificationCode" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Name" type="{http://ed-fi.org/0100RFC}Name"/>
 *         &lt;element name="OtherName" type="{http://ed-fi.org/0100RFC}OtherName" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Sex" type="{http://ed-fi.org/0100RFC}SexType"/>
 *         &lt;element name="BirthData" type="{http://ed-fi.org/0100RFC}BirthData"/>
 *         &lt;element name="Address" type="{http://ed-fi.org/0100RFC}Address" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Telephone" type="{http://ed-fi.org/0100RFC}Telephone" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ElectronicMail" type="{http://ed-fi.org/0100RFC}ElectronicMail" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ProfileThumbnail" type="{http://ed-fi.org/0100RFC}ProfileThumbnail" minOccurs="0"/>
 *         &lt;element name="HispanicLatinoEthnicity" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         &lt;element name="OldEthnicity" type="{http://ed-fi.org/0100RFC}OldEthnicityType" minOccurs="0"/>
 *         &lt;element name="Race" type="{http://ed-fi.org/0100RFC}RaceType"/>
 *         &lt;element name="EconomicDisadvantaged" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="SchoolFoodServicesEligibility" type="{http://ed-fi.org/0100RFC}SchoolFoodServicesEligibilityType" minOccurs="0"/>
 *         &lt;element name="StudentCharacteristics" type="{http://ed-fi.org/0100RFC}StudentCharacteristic" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="LimitedEnglishProficiency" type="{http://ed-fi.org/0100RFC}LimitedEnglishProficiencyType" minOccurs="0"/>
 *         &lt;element name="Languages" type="{http://ed-fi.org/0100RFC}LanguagesType" minOccurs="0"/>
 *         &lt;element name="HomeLanguages" type="{http://ed-fi.org/0100RFC}LanguagesType" minOccurs="0"/>
 *         &lt;element name="Disabilities" type="{http://ed-fi.org/0100RFC}Disability" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Section504Disabilities" type="{http://ed-fi.org/0100RFC}Section504DisabilitiesType" minOccurs="0"/>
 *         &lt;element name="DisplacementStatus" type="{http://ed-fi.org/0100RFC}DisplacementStatusType" minOccurs="0"/>
 *         &lt;element name="ProgramParticipations" type="{http://ed-fi.org/0100RFC}ProgramParticipation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="LearningStyles" type="{http://ed-fi.org/0100RFC}LearningStyles" minOccurs="0"/>
 *         &lt;element name="CohortYears" type="{http://ed-fi.org/0100RFC}CohortYear" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="StudentIndicators" type="{http://ed-fi.org/0100RFC}StudentIndicator" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends ComplexObjectType
{
    ...
    protected int studentUniqueStateId;
     ...
     * 
     */
    public int getStudentUniqueStateId() {
     ...
     * 
     */
    public void setStudentUniqueStateId(int value) {
