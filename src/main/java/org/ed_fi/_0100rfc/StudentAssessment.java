...
/**
 * This represents the analysis or scoring of a student's response on an assessment. The analysis results in a value that represents a students performance on a set of items on a test.
 * 
 ...
 *         &lt;element name="SerialNumber" type="{http://ed-fi.org/0100RFC}IdentificationCode" minOccurs="0"/>
 *         &lt;element name="AdministrationLanguage" type="{http://ed-fi.org/0100RFC}LanguageItemType" minOccurs="0"/>
 *         &lt;element name="AdministrationEnvironment" type="{http://ed-fi.org/0100RFC}AdministrationEnvironmentType" minOccurs="0"/>
 *         &lt;element name="SpecialAccommodations" type="{http://ed-fi.org/0100RFC}SpecialAccommodationsType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="LinguisticAccommodations" type="{http://ed-fi.org/0100RFC}LinguisticAccommodationsType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="RetestIndicator" type="{http://ed-fi.org/0100RFC}RetestIndicatorType" minOccurs="0"/>
 *         &lt;element name="ReasonNotTested" type="{http://ed-fi.org/0100RFC}ReasonNotTestedType" minOccurs="0"/>
 *         &lt;element name="ScoreResults" type="{http://ed-fi.org/0100RFC}ScoreResult" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="GradeLevelWhenAssessed" type="{http://ed-fi.org/0100RFC}GradeLevelType" minOccurs="0"/>
 *         &lt;element name="PerformanceLevelReference" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://ed-fi.org/0100RFC}PerformanceLevelReferenceType">
 *                 &lt;sequence>
 *                   &lt;element name="PerformanceLevelIdentity" type="{http://ed-fi.org/0100RFC}PerformanceLevelIdentityType" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/extension>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 ...
 *         &lt;element name="AssessmentReference" type="{http://ed-fi.org/0100RFC}AssessmentReferenceType"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends ComplexObjectType
{
    ...
    protected List<StudentAssessment.PerformanceLevelReference> performanceLevelReference;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StudentAssessment.PerformanceLevelReference }
     * 
     * 
     */
    public List<StudentAssessment.PerformanceLevelReference> getPerformanceLevelReference() {
        if (performanceLevelReference == null) {
            performanceLevelReference = new ArrayList<StudentAssessment.PerformanceLevelReference>();
        }
    ...
    @XmlType(name = "", propOrder = {
        "performanceLevelIdentity"
    })
    public static class PerformanceLevelReference
        extends PerformanceLevelReferenceType
    {

        @XmlElement(name = "PerformanceLevelIdentity")
        protected PerformanceLevelIdentityType performanceLevelIdentity;

        /**
         * Gets the value of the performanceLevelIdentity property.
         * 
         * @return
         *     possible object is
         *     {@link PerformanceLevelIdentityType }
         *     
         */
        public PerformanceLevelIdentityType getPerformanceLevelIdentity() {
            return performanceLevelIdentity;
        }

        /**
         * Sets the value of the performanceLevelIdentity property.
         * 
         * @param value
         *     allowed object is
         *     {@link PerformanceLevelIdentityType }
         *     
         */
        public void setPerformanceLevelIdentity(PerformanceLevelIdentityType value) {
            this.performanceLevelIdentity = value;
        }
