...
/**
 * A tool, instrument, process, or exhibition composed of a systematic sampling of behavior for measuring a student's competence, knowledge, skills or behavior. An assessment can be used to measure differences in individuals or groups and changes in performance from one occasion to the next.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="AssessmentTitle" type="{http://ed-fi.org/0100RFC}AssessmentTitle"/>
 *         &lt;element name="AssessmentIdentificationCode" type="{http://ed-fi.org/0100RFC}AssessmentIdentificationCode" maxOccurs="unbounded"/>
 *         &lt;element name="AssessmentCategory" type="{http://ed-fi.org/0100RFC}AssessmentCategoryType" minOccurs="0"/>
 *         &lt;element name="AcademicSubject" type="{http://ed-fi.org/0100RFC}AcademicSubjectType" minOccurs="0"/>
 *         &lt;element name="GradeLevelAssessed" type="{http://ed-fi.org/0100RFC}GradeLevelType" minOccurs="0"/>
 ...
 *         &lt;element name="AssessmentForm" type="{http://ed-fi.org/0100RFC}AssessmentForm" minOccurs="0"/>
 *         &lt;element name="Version" type="{http://ed-fi.org/0100RFC}Version" minOccurs="0"/>
 ...
 *         &lt;element name="ObjectiveAssessmentReference" type="{http://ed-fi.org/0100RFC}ReferenceType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AssessmentFamilyReference" type="{http://ed-fi.org/0100RFC}AssessmentFamilyReferenceType" minOccurs="0"/>
 *         &lt;element name="SectionReference" type="{http://ed-fi.org/0100RFC}SectionReferenceType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AssessmentPeriodReference" type="{http://ed-fi.org/0100RFC}AssessmentPeriodReferenceType" minOccurs="0"/>
    ...
    extends ComplexObjectType
{
    ...
    protected AssessmentPeriodReferenceType assessmentPeriodReference;
     ...
     *     
     */
    public AssessmentPeriodReferenceType getAssessmentPeriodReference() {
        return assessmentPeriodReference;
    }

    /**
     * Sets the value of the assessmentPeriodReference property.
     * 
     * @param value
     *     allowed object is
     *     {@link AssessmentPeriodReferenceType }
     *     
     */
    public void setAssessmentPeriodReference(AssessmentPeriodReferenceType value) {
        this.assessmentPeriodReference = value;
    }
